...
const ProjectCard = ({ index, domain, title, description, tags, onViewDeepDive }) => {
  return (
    <div className="bg-surface-container-low p-8 rounded-xl border border-outline-variant/10 flex flex-col h-full transform transition-all duration-300 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5 group">
      ...
      <button
        ...
        className="self-start px-6 py-2 border border-outline-variant/20 text-[10px] text-primary font-mono uppercase tracking-widest text-on-surface-variant hover:text-primary hover:border-primary/40 transition-all active:scale-95"
      >
        View Deep Dive
      </button>
    </div>
